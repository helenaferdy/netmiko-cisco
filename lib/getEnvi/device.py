...
class Routers:
    def __init__(self, hostname, ip, username, password, secret, ios_os, protocol, command1):
        ...
        self.out_path = "out/getEnvironment/"
        self.log_path = "log/getEnvironment.log"
        self.errorlog_path = "log/error/"
        self.errorlog = self.errorlog_path+"getEnvironment-error.log"
    ...
    def export_csv(self, parsed):
        ...
        final = [self.i ,self.hostname, "DC", power, fan, temp]
